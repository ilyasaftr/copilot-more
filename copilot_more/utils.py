...
def generate_machine_id() -> str:
    """Generate a VSCode machine ID"""
    return gen_hex_str(64)


def generate_session_id() -> str:
    """Generate a VSCode session ID"""
    return f"{gen_hex_str(8)}-{gen_hex_str(4)}-{gen_hex_str(4)}-{gen_hex_str(4)}-{gen_hex_str(25)}"


def generate_request_id() -> str:
    """Generate a request ID"""
    return f"{gen_hex_str(8)}-{gen_hex_str(4)}-{gen_hex_str(4)}-{gen_hex_str(4)}-{gen_hex_str(12)}"
